If your project contains externally linked files, these files can be moved, renamed, or deleted. Linked files are sown with a red link icon.
...
If you are importing an REFI-QDA project with external links, you will need to update the links to files using this function.